...
!function () {
    ...
    f.prototype = {
        ...
        init: function (a, b, c) {
            ...
            if ("number" == typeof b) {
                ...
                if ("undefined" != typeof a.additionalProperties || !this.jsoneditor.options.no_additional_properties || a.oneOf || a.anyOf || (a.additionalProperties = !1), "undefined" != typeof a.additionalProperties)for (h in b)if (b.hasOwnProperty(h) && !q[h]) {
        ...
        register: function () {
            ...
            if (this.source_code)if (this.options.wysiwyg && ["html", "bbcode"].indexOf(this.input_type) >= 0 && window.jQuery && window.jQuery.fn && window.jQuery.fn.sceditor)a = c({}, {
                plugins: "html" === b.input_type ? "xhtml" : "bbcode", emoticonsEnabled: !1,
        ...
        setValue: function (a, b) {
            ...
            a = -1 === this.enum_options.indexOf(b) ? this.enum_values[0] : this.enum_values[this.enum_options.indexOf(b)], a !== this.value && (this.value = a, this.onChange(!0))
        ...
        setValue: function (a, b) {
            ...
            this.label && this.label.parentNode && this.label.parentNode.removeChild(this.label), this.description && this.description.parentNode && this.description.parentNode.removeChild(this.description), this.input && this.input.parentNode && this.input.parentNode.removeChild(this.input),
            this.selectize && (this.selectize[0].selectize.destroy(), this.selectize = null), this._super()
        }
    ...
    f.AbstractTheme = a.extend({
        ...
        getFormInputLabel: function (a) {
            var b = this._super(a);
            return b.style.display = "block", b.style.marginBottom = "3px", b.style.fontWeight = "bold",
                b
        }, getFormInputDescription: function (a) {
            var b = this._super(a);
    ...
    f.defaults.resolvers.unshift(function (a) {
        ...
        return "boolean" === a.type ? "checkbox" === a.format || a.options && a.options.checkbox ? "checkbox" : f.plugins.selectize.enable ? "selectize" : "select" : void 0
    }), f.defaults.resolvers.unshift(function (a) {
        ...
        return a.enumSource ? f.plugins.selectize.enable ? "selectize" : "select" : void 0
    }), f.defaults.resolvers.unshift(function (a) {
        if (a["enum"]) {
